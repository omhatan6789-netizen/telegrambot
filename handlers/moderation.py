...
async def resolve_target(
    ...
    if target_text.startswith("@"):
        username = normalize_username(target_text)
        if not username:
            return None, []
        # ------------------------------------------
        # أولاً users
        ...
        try:
            ...
            pass
        # ------------------------------------------
        # لا نحاول get_chat هنا
        #
        # Telegram get_chat لا يحوّل username
        # لمستخدم عادي إلى User ID.
        # ------------------------------------------
        return None, []
    return None, []
